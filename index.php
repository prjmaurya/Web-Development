...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- keywords -->
        <meta name="keywords" content=" electronic ,robotics, electronic society, iot, eda, electronics, club, creative, modern, clean, bootstrap responsive, html5, css3, portfolio, blog, agency, templates, multipurpose, one page, corporate, start-up, studio, branding, designer, freelancer, carousel, parallax, photography, personal, masonry, grid, coming soon, faq" />
        <!-- favicon -->
        <link rel="shortcut icon canonical" href="./images/favicon.png" />
                ...
                <div class="container nav-header-container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-8">
                            <a href="./index.php" title="Tesla" class="logo"><img src="./images/Tesla_Logo.jpg" alt="Tesla" class="logo-light default"  /><img src="./images/Tesla_Logo.jpg" class="logo-dark"  alt="Tesla" /></a>
                        </div>
                ...
                <div class="slider-typography text-center">
                    <div class="slider-text-middle-main">
                        <div class="slider-text-middle">
                            ...
                            <h1 class="alt-font text-uppercase text-white font-weight-700 width-75 xs-width-90 center-col margin-35px-bottom" >Tesla
                            <span class="text-large text-very-light-gray font-weight-300 width-95 center-col margin-25px-bottom display-block xs-width-85">Electronics & Automation Society, IIIT Allahabad</span></h1>
                        </div>
                    </div>
                </div>
            </div>
