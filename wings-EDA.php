...
<body>
    ...
    <header>
        <!-- start navigation -->
        <nav class="navbar navbar-default bootsnav bg-black header-dark bg-transparent white-link navbar-top">
      ...
      <section class="bg-light-gray" style="margin-top: 70px">
            <div class="container">
                <div class="row equalize sm-equalize-auto">
                    <div class="col-md-6 col-sm-12 sm-margin-30px-bottom wow fadeInLeft">
                        <div class="display-table">
                            <div class="display-table-cell vertical-align-middle">
                                <img src="./images/wing_eda_1a.jpg"  alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12  wow fadeInRight">
                        <div class="display-table width-100 heidth-100">
                            <div class="display-table-cell vertical-align-middle" style="text-align: justify; margin-left: 2px">
                                
                                <h5 class="alt-font text-extra-dark-gray font-weight-500" style="margin: 5% 0">Electronic Design Automation (EDA Wing)</h5>
                                <p style="font-size: 16px">Electronic design automation (EDA), also referred to as electronic computer-aided design (ECAD), is a category of software tools for designing electronic systems such as integrated circuits and printed circuit boards. The tools work together in a design flow that chip designers use to design and analyze entire semiconductor chips. Since a modern semiconductor chip can have billions of components, EDA tools are essential for their design.</p>
                               <p style="font-size: 16px">1981 marks the beginning of EDA as an industry. For many years, the larger electronic companies, such as Hewlett Packard, Tektronix, and Intel, had pursued EDA internally. In 1981, managers and developers spun out of these companies to concentrate on EDA as a business. Daisy Systems, Mentor Graphics, and Valid Logic Systems were all founded around this time, and collectively referred to as DMV. Within a few years there were many companies specializing in EDA, each with a slightly different emphasis. The first trade show for EDA was held at the Design Automation Conference in 1984.</p>
                               ...
                               <!-- <a href="./services-modern.php" class="btn btn-dark-gray btn-small text-extra-small">View more info</a>-->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--<div class="separator-line-horrizontal-full bg-extra-light-gray  height-2px width-80 center-col"></div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-8 col-xs-12 center-col margin-eight-bottom sm-margin-40px-bottom xs-margin-30px-bottom text-center">
                        ...
                        <h5 class="alt-font text-extra-dark-gray font-weight-500">Projects</h5>
                        <div class="alt-font text-medium-gray margin-10px-bottom text-medium">Here are some of the projects for your quick review</div>
                                    ...
                                    <div class="row col-4-nth sm-col-2-nth" id="loop">
                           
                                        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp list-sec pad-pro" data-wow-delay="0.6s">
                                                <div class="blog-post blog-post-style1 xs-text-center">
                                                    <div class="blog-post-images overflow-hidden margin-25px-bottom sm-margin-20px-bottom">
                                                        <a href="./blog-post-layout-02.php">
                                                            <img src="./images/blog-img46.jpg" alt="" />
                                                        </a>
                                                    </div>
                                                    <div class="post-details">
                                                        <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-10px-bottom  xs-margin-5px-bottom">14 January 2017 | by Matthew Spencer</span>
                                                        <a href="./blog-post-layout-02.php" class="post-title text-medium text-extra-dark-gray width-90 display-block sm-width-100">Get in over your head as often and as joyfully as possible.</a>
                                       ...
                                       <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp list-sec pad-pro" data-wow-delay="0.6s">
                                            <div class="blog-post blog-post-style1 xs-text-center">
                                                ...
                                                <div class="post-details">
                                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-10px-bottom  xs-margin-5px-bottom">14 January 2017 | by <a href="blog-masonry.php" class="text-medium-gray">Matthew Spencer</a></span>
                                                    <a href="./blog-post-layout-02.php" class="post-title text-medium text-extra-dark-gray width-90 display-block sm-width-100">Get in over your head as often and as joyfully as possible.</a>
                                                    <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb sm-margin-15px-tb"></div>
                                                    <p class="width-90 xs-width-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                                                </div>
                                    ...
                                    <div class=" text-center margin-100px-top sm-margin-50px-top wow fadeInUp">
                                        <div class="pagination text-small text-uppercase text-extra-dark-gray">
                                            <ul class="paginate">
                                                <li id="previous-page"><a href="#"><i class="fa fa-long-arrow-left margin-5px-right xs-display-none"></i> Prev</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-8 col-xs-12 center-col margin-eight-bottom sm-margin-40px-bottom xs-margin-30px-bottom text-center">
                        ...
                        <h5 class="alt-font text-extra-dark-gray font-weight-500">Tutorials</h5>
                        <div class="alt-font text-medium-gray margin-10px-bottom text-medium">Here are some of the Tutorials for your guidance.</div>
